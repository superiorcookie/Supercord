...
export const DATA_DIR =
    process.env.SUPERCORD_USER_DATA_DIR || (PORTABLE ? join(equibopDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Equibop/${app.getVersion()} (https://github.com/Supercord/Equibop)`;
