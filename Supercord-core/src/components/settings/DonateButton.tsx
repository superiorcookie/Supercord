...
export function DonateButton({
    ...
    className,
    ...props
}: Partial<ButtonProps> & { supercord?: boolean; }) {
    const link = supercord ? "https://github.com/sponsors/thororen1234" : "https://github.com/sponsors/Vendicated";
    return (
        <Button
            {...props}
            variant="none"
...
export function TranslateButton({
    ...
    const link = "https://weblate.supercord.org/projects/supercord/";
    return (
        <Button
            {...props}
            variant="none"
