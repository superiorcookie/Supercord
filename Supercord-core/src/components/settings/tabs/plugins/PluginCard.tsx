    ...
    const pluginInfo = [
        {
            ...
            src: "https://supercord.org/assets/icons/supercord/modified.png",
            alt: "Modified",
        ...
        },
        {
            ...
            src: "https://supercord.org/assets/icons/vencord/icon-light.png",
            alt: "Vencord",
            title: "Vencord Plugin"
        },
        {
            condition: isUserPlugin,
            src: "https://supercord.org/assets/icons/misc/userplugin.png",
            alt: "User",
            title: "User Plugin"
        }
    ];
