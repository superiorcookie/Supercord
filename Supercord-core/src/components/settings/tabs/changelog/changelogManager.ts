...
const CHANGELOG_HISTORY_KEY = "SupercordChangelog_History";
const LAST_SEEN_HASH_KEY = "SupercordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "SupercordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "SupercordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "SupercordChangelog_LastRepoCheck";
