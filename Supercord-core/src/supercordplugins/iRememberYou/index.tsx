...
export default definePlugin({
    ...
    tags: ["Chat", "Servers"],
    authors: [SupercordDevs.zoodogood, SupercordDevs.keircn],
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "supercord_i_remember_you");
