...
const NOTIFICATION_AUDIO_URL = "https://raw.githubusercontent.com/Supercord/Equibored/main/sounds/waitForSlot/notification.mp3";
...
export default definePlugin({
    ...
    authors: [SupercordDevs.omaw, Devs.prism],
    settings,
    patches: [
        {
