        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Supercord Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("SupercordToolbox", "VencordToolbox");
export default definePlugin({
    name: "SupercordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Supercord quick actions",
