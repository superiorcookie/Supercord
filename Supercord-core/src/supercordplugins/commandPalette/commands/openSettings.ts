...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "supercord_main", label: "Supercord", keywords: ["vencord"] },
    { route: "supercord_plugins", label: "Supercord Plugins", keywords: ["plugins"] },
    { route: "supercord_themes", label: "Supercord Themes", keywords: ["themes", "css"] },
    { route: "supercord_updater", label: "Supercord Updater", keywords: ["update"] },
    { route: "supercord_changelog", label: "Supercord Changelog", keywords: ["changelog", "news"] }
];
...
const ROUTE_ALIASES = new Map<string, string[]>([
    ...
    ["supercord_main", ["supercord_main_panel"]],
    ["supercord_plugins", ["supercord_plugins_panel"]],
    ["supercord_themes", ["supercord_themes_panel"]],
    ["supercord_updater", ["supercord_updater_panel"]],
    ["supercord_changelog", ["supercord_changelog_panel"]]
]);
