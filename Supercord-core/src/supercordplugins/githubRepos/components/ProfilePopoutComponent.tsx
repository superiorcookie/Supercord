...
import { fetchReposByUserId, fetchReposByUsername, fetchUserInfo, GitHubUserInfo } from "@supercordplugins/githubRepos/githubApi";
import { GitHubRepo } from "@supercordplugins/githubRepos/types";
