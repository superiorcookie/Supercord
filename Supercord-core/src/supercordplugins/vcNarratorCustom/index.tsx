...
export default definePlugin({
    ...
    authors: [Devs.Ven, Devs.Nyako, SupercordDevs.Loukios, SupercordDevs.examplegit, SupercordDevs.qdnx],
    settings,
    contextMenus: {
    ...
    settingsAboutComponent({ tempSettings: s }: { tempSettings?: any; }) {
        ...
        const authorUser = UserStore.getUser(String(SupercordDevs.examplegit.id));
