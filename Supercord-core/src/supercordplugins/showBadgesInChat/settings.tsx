...
const settings = definePluginSettings({
    showSupercordDonor: {
        ...
        description: "Enable to show Supercord Donor badges in chat.",
        hidden: true,
        default: true
    },
    SupercordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Supercord Donor badges.",
        hidden: true,
        default: 0
    },
    showSupercordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Supercord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    SupercordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Supercord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://badge.supercord.org/donor.webp", shown: settings.store.showSupercordDonor, title: "Supercord donor badges", key: "SupercordDonor", position: settings.store.SupercordDonorPosition },
        { src: "https://supercord.org/assets/favicon.png", shown: settings.store.showSupercordContributor, title: "Supercord contributor badge", key: "SupercordContributer", position: settings.store.SupercordContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "SupercordDonor":
                    settings.store.SupercordDonorPosition = image.position;
                    settings.store.showSupercordDonor = image.shown;
                    break;
                case "SupercordContributer":
                    settings.store.SupercordContributorPosition = image.position;
                    settings.store.showSupercordContributor = image.shown;
                    break;
                case "VencordDonor":
