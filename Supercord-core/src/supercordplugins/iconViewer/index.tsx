...
export default definePlugin({
    ...
    tags: ["Developers"],
    authors: [SupercordDevs.iamme],
    dependencies: ["Settings", "ConcatenatedModules"],
    startAt: StartAt.WebpackReady,
    toolboxActions: {
        "Open Icons Tab"() {
            SettingsRouter.openUserSettings("supercord_icon_viewer_panel");
        },
    },
    settingsAboutComponent: SettingsAbout,
    start() {
        SettingsPlugin.customEntries.push({
            key: "supercord_icon_viewer",
            title: "Icon Finder",
            Component: IconsTab,
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "supercord_icon_viewer");
    },
});
