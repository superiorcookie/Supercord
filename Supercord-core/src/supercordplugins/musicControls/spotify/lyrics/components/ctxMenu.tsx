...
import { providers } from "@supercordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@supercordplugins/musicControls/spotify/lyrics/providers/store";
