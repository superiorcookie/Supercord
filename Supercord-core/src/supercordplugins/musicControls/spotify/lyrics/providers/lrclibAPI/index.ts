...
import { LyricsData, Provider } from "@supercordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@supercordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Supercord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
