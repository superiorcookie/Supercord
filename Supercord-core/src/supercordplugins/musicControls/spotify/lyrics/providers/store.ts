...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@supercordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@supercordplugins/musicControls/spotify/SpotifyStore";
