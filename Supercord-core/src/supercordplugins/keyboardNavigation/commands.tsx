...
export const actions: ButtonAction[] = [
    { id: "openSupercordSettings", label: "Open Supercord tab", callback: async () => await SettingsRouter.openUserSettings("supercord_main_panel"), registrar: "Supercord" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("supercord_plugins_panel"), registrar: "Supercord" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("supercord_themes_panel"), registrar: "Supercord" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("supercord_updater_panel"), registrar: "Supercord" },
    { id: "openSupercordCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("supercord_cloud_panel"), registrar: "Supercord" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("supercord_backup_restore_panel"), registrar: "Supercord" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "Supercord" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "Supercord" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "Supercord" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "Supercord" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A Supercord update is available!",
                    body: "Click here to view the update",
                    permanent: true,
                    noPersist: true,
                    onClick() {
                        SettingsRouter.openUserSettings("supercord_updater_panel");
                    }
                }), 10_000);
            } else {
                Toasts.show({
