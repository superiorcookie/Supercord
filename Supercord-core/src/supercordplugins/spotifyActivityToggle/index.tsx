...
import supercordToolbox from "@supercordplugins/supercordToolbox";
...
function SpotifyActivityToggleButton({ iconForeground, hideTooltips, nameplate }: UserAreaRenderProps) {
    ...
    if (!isLoaded || !spotifyId || location !== "PANEL" && isPluginEnabled(supercordToolbox.name)) return null;
...
const settings = definePluginSettings({
    location: {
        ...
        options: [
            ...
            { label: "Supercord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(supercordToolbox.name);
        }
    },
});
