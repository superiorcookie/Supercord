...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{supercordIcon} Supercord {supercordVersion} ({supercordHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "Supercord Variables:",
    "{supercordIcon} - Supercord icon",
    "{supercordVersion} - Version of Supercord (e.g. 1.0.0)",
    "{supercordHash} - Supercord build hash (e.g. 123456789)",
    "{supercordPlatform} - Platform Supercord is running on (e.g. Dev Build)",
    "",
