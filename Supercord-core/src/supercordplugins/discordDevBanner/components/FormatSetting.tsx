...
export function FormatSetting(setValue) {
    ...
    const [state, setState] = useState(format ?? "{buildChannel} {buildNumber} ({buildHash}) | {supercordName} {supercordVersion} ({supercordHash})");
    ...
    return (
        <section>
            ...
            <textarea
                ...
                placeholder="{buildChannel} {buildNumber} ({buildHash}) | {supercordName} {supercordVersion} ({supercordHash})"
                rows={1}
                ref={el => {
                    if (el) {
