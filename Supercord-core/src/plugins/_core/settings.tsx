...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Supercord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "supercord_section")) return layout;

        const { buildEntry } = this;

        const supercordEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "supercord_main",
                title: "Supercord",
                panelTitle: "Supercord Settings",
                Component: VencordTab,
                Icon: MainSettingsIcon
            }),
            buildEntry({
                key: "supercord_plugins",
                title: "Plugins",
                Component: PluginsTab,
                Icon: PluginsIcon
            }),
            buildEntry({
                key: "supercord_themes",
                title: "Themes",
                Component: ThemesTab,
                Icon: PaintbrushIcon
            }),
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "supercord_updater",
                title: "Updater",
                panelTitle: "Supercord Updater",
                Component: UpdaterTab,
                Icon: UpdaterIcon
            }),
            buildEntry({
                key: "supercord_changelog",
                title: "Changelog",
            ...
            buildEntry({
                key: "supercord_cloud",
                title: "Cloud",
                panelTitle: "Supercord Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "supercord_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "supercord_patch_helper",
                title: "Patch Helper",
        ...
        const supercordSection: SettingsLayoutNode = {
            key: "supercord_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "Supercord Settings",
            buildLayout: () => supercordEntries
        };
        ...
        layout.splice(idx, 0, supercordSection);
    ...
    getInfoRows() {
        ...
        const rows = [`Supercord ${gitHashShort}${getVersionInfo()}`];
