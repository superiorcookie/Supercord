...
Supercord is a community project and welcomes any kind of contribution from anyone!

We have development documentation for new contributors, which can be found at <https://docs.supercord.org>.
...
To keep Supercord stable, secure and maintainable, all plugins must follow these rules:
...
## Improving Supercord Itself

If you want to improve Supercord beyond plugins, such as internal features or performance improvements, you are welcome to open a feature request so it can be discussed.

Bug fixes, refactors, and documentation improvements are also highly appreciated!

## Helping the Community

We have an open support channel in our [Discord community](https://supercord.org/discord).
